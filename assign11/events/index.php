...
if ($action == 'list_events') {
    ...
    $message = $records_added > 0 ? 'Event Added' : 'Error Adding Event';
    $events = read_events();
    include('events_list.php');
    ...
    $message = $records_updated > 0 ? ' Event Updated': 'Error Updating Event';
    $events = read_events();
    include('events_list.php');
    ...
    $message = $deleted_rows > 0 ? 'Event Deleted' : 'Error Deleting Event';
    $events = read_events();
    include('events_list.php');
}
